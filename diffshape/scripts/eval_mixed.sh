...
MODELS=(
  "checkpoints/diff_cc359-gbm125-nfbs_T500_b0.002.pth"
  "checkpoints/diff_r_cc359-gbm125-nfbs_T500_b0.002.pth"
  "checkpoints/diff_r_rm_cc359-gbm125-nfbs_T500_b0.002.pth"
)
...
echo "=== Mixed-model evaluations complete ==="
